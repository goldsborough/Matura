...
Gilt $0 < b < 1$, f\"{a}llt die Funktion, da eine Zahl zwischen 0 und 1 mit sich selbst multipliziert noch kleiner wird. Zwischen $x = 0$ und $x = 1$ hat eine solche fallende Exponentialunktion hohe Funktionswerte, da die rationalen $x$-Werte zwischen 0 und 1 als Exponenten gleich einer Wurzel sind. Zieht man aus einem $b$, f\"{u}r welches gilt $0 < b < 1$, eine Wurzel in diesem Bereich, vergr\"{o}\ss{}ert sich der Wert.
