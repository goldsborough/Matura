...
Die Ableitung einer Funktion $f(x)$ ordnet jedem unabh\"{a}ngigen $x$-Wert auf der Abszisse bzw. aus der Definitionsmenge $\mathbb{D}_f$ den Differentialquotienten an dieser Stelle als neuen Funktionswert der Ableitungsfunktion $f'(x)$ zu. 
