...
\centering
	\begin{tikzpicture}
		...
		% ellipsis
		\draw [red] (4, 4) circle [x radius = 3, y radius = 2];
...
\centering
	\begin{tikzpicture}
		...
		\draw [red, domain=1.8:6.2, rotate=90] plot (\x, {0.5 * \x*\x - 4 * \x + 5});

		% hyperbola, right branch
		\draw [red, domain=-6.2:-1.8, rotate=-90] plot (\x, {0.5 * \x*\x + 4 * \x + 13});
