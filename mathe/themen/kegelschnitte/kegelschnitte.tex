...
Eine Ellipse kann als eine ovale Kurve oder als ein Kreis mit zwei verschiedenen Radii $a$ und $b$ f\"{u}r die x- bzw. y-Achse, anstatt nur einem Radius $r$, gesehen werden. Sie ist definiert durch zwei Brennpunkte $F_{1}$ und $F_{2}$ sowie einer Zahl $a > 0$. Eine vollst\"{a}ndig beschriftete Ellipse $ell$ mit einem Punkt $X$ sieht so aus:
